    ...
    <aside class="right-side">
        ...
        <section class="content">
            ...
            <form method="post" action="">
                <table  border=0 cellpadding="1" cellspacing="1" id="" width="100%" class="table table-hover table-striped table-condensed"><thead><tr><th>Name</th><th>Price</th><th>Total</th></tr></thead>
                    <tbody>
                    <?php
